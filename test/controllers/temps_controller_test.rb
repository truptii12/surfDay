...
class TempsControllerTest < ActionController::TestCase
  ...
  test "should create temp" do
    assert_difference('Temp.count') do
      post :create, temp: { day: @temp.day, eve: @temp.eve, max: @temp.max, min: @temp.min, morn: @temp.morn, night: @temp.night }
    end
  ...
  test "should update temp" do
    patch :update, id: @temp, temp: { day: @temp.day, eve: @temp.eve, max: @temp.max, min: @temp.min, morn: @temp.morn, night: @temp.night }
    assert_redirected_to temp_path(assigns(:temp))
  end
